...
RSpec.feature "Shopping List", type: :feature do
  ...
  let!(:food1) { create(:food, user: user, name: "Apple", quantity: -5, measurement_unit: "kg", price: 15) }
  let!(:food2) { create(:food, user: user, name: "Banana", quantity: -3, measurement_unit: "pcs", price: 5) }
